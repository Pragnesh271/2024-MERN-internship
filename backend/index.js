...
// Database MongoDB
mongoose.connect("mongodb+srv://pragnesh:lambMERN@cluster0.wa8bg8m.mongodb.net/");
...
//Creating endpoint for adding the product in cart
...
app.post('/removefromcart', fetchuser, async (req, res) => {
  ...
  //Create a saving of product in cart
